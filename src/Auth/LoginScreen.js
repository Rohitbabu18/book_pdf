...
export default function LoginScreen() {
    ...
    return (
        <SafeAreaView style={GloableStyle.container}>
            ...
            <Spacer height={10} />
            <MediumText style={GloableStyle.headerText1}>Enter Your Number for</MediumText>
            ...
            <View style={{ flexDirection: 'row' }}>
                ...
                <View style={{ width: '85%' }}>
                    ...
                    >
                        ...
                        <Text style={{ marginLeft: horizScale(25), fontSize: Fonts.size.regular, color: Colors.black }}>+91 </Text>
                        <TextInput
                            style={{ marginLeft: horizScale(5), fontSize: Fonts.size.regular, color: Colors.black }}
                            placeholder={'Mobile Number'}
                            maxLength={10}
                            onChangeText={(value) => { setstate({ ...state, number: value }) }}
                            keyboardType={'number-pad'} />
                    </View>
                    <View style={{ ...GloableStyle.horizline, backgroundColor: state.number ? Colors.button : Colors.gray }} />
                </View>
            </View>
            <Spacer height={100} />
