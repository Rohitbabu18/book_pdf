...
// import FocusStatusBar from '../Utils/Components/FocusStatusBar';
import Colors from '../Utils/Colors';
import OTPTextInput from 'react-native-otp-textinput';
import CustomImage from '../Utils/Images';
import Fonts from '../Utils/Fonts';
import { horizScale, vertScale, Text, MediumText, BoldText, BlackText, Spacer } from '../Utils/LayoutUtil';
...
export default function OTPVerify(props) {
    ...
    return (
        <ScrollView style={GloableStyle.container}>
            {console.log("length=", state.inputCode.length)}
            ...
            <MediumText style={GloableStyle.headerText1}>Check Your Mobile and</MediumText>
            <BoldText style={GloableStyle.headerText2}>Enter OTP Number</BoldText>


            <Text style={styles.text}>
                We've send an OTP to {state.number} mobile
                number. Please check your message box and enter
                number
            </Text>
            <Image
                source={CustomImage.otp}
                style={styles.Image}
            />
            <Spacer height={30} />
            <OTPTextInput
            ...
            <TouchableOpacity style={GloableStyle.button}
                onPress={() => {
                    props.navigation.navigate('ProfilePage1');
                }}>
