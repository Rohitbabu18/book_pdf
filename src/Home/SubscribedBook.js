...
export default function SubscribedBook(props) {
  ...
  return (
    <SafeAreaView style={GloableStyle.container}>
      ...
      />
      <Spacer height={5} />
      <View style={{...GloableStyle.backView, marginLeft: 0}}>
        <TouchableOpacity
          onPress={() => {
            props.navigation.goBack();
          }}
          style={GloableStyle.backView}>
          <Image source={CustomImage.back} style={GloableStyle.backImage} />
        </TouchableOpacity>
        <MediumText style={GloableStyle.backText}>Back</MediumText>
      ...
      <TouchableOpacity
        ...
        style={styles.search}>
        <Image
          source={CustomImage.search}
          style={{marginLeft: horizScale(20)}}></Image>
        <TextInput
          placeholder="Search"
          placeholderTextColor={Colors.gray}
          maxLength={50}
          onChangeText={hospital => {
            setState({...state, searchedHospital: hospital});
          }}
      ...
      <FlatList
        ...
        renderItem={({item}) => (
          <Pressable
            onPress={() => {
              props.navigation.navigate('PdfScreen', {item});
            }}
            ...
            <View
              ...
              <Text numberOfLines={2} style={styles.writer}>
                {item.writer}
              </Text>
